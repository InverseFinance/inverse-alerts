...
class handler():
    ...
    def compose(self):
        ...
        self.webhook = os.getenv('WEBHOOK_DWF')
        from_address = self.tx["args"]["from"]
        to_address = self.tx["args"]["to"]
        amount = self.tx["args"]["amount"] / 1e18

        if from_address == "0x834FF5670A72EAa0166c5E494f9c80F0E77F6551" or to_address == "0x834FF5670A72EAa0166c5E494f9c80F0E77F6551":
            
            inv_balance = getBalance(self.web3, "0x834FF5670A72EAa0166c5E494f9c80F0E77F6551",
                                    "0x41d5d79431a913c4ae7d69a668ecdfe5ff9dfb68")

            self.title = "DWF - INV activity detected"
