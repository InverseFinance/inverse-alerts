    ...
    def compose(self):
        ...
        self.fields = [{"name": 'Block Number :', "value": str(f'[{blockNumber}](https://etherscan.io/block/{blockNumber})'),
                  ...
                  {"name": 'ETH Value :', "value": str(
                      formatCurrency(self.tx["args"]["borrowAmount"] / underlying_decimals * underlying_price)),
                   "inline": True},
                  {"name": 'Borrow Amount :',
                   "value": str(formatCurrency(self.tx["args"]["borrowAmount"] / underlying_decimals)), "inline": True},
